...
internal fun deployment(key: String, projectId: String = "1") = Deployment(
    id = "1",
    projectId = projectId,
    label = "",
    key = key,
...
internal fun Deployment.toSerialDeployment(deleted: Boolean = false) = SerialDeployment(
    id = id,
    projectId = projectId,
    label = label,
    key = key,
...
internal fun project(id: String = "1") = Project(
    id = id,
    apiKey = "api",
    secretKey = "secret",
