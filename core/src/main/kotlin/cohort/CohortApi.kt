...
data class GetCohortResponse(
    ...
    companion object {
        fun fromCohort(cohort: Cohort) = GetCohortResponse(
            cohortId = cohort.id,
...
internal interface CohortApi {
    suspend fun getCohort(cohortId: String, lastModified: Long?, maxCohortSize: Int): Cohort
}
...
internal class CohortApiV1(
    ...
    override suspend fun getCohort(cohortId: String, lastModified: Long?, maxCohortSize: Int): Cohort {
